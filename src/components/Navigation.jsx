        ...
        >
            <Container fluid className="containerNavBar">
                <Navbar.Brand href="/" className="d-flex">
                    <p style={{marginTop: "15px"}}><strong className="main-name"> D</strong>egen <strong
                        className="main-name">B</strong>ounty <strong className="main-name">H</strong>unter</p>
                </Navbar.Brand>
                <Navbar.Toggle
                    ...
                    <Nav className="ms-auto" defaultActiveKey="#home">
                        ...
                        <Nav.Item>
                            <Nav.Link
                                ...
                                onClick={() => updateExpanded(false)}
                            >
                                <AiOutlineThunderbolt style={{marginBottom: "2px"}}/> Gen<strong
                                className="main-name">0</strong>
                            </Nav.Link>
                        </Nav.Item>
